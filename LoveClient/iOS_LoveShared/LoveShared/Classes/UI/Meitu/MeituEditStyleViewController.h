...
@interface MeituEditStyleViewController : UIViewController<GLStoryboardSelectViewDelegate,GLPosterSelectViewDelegate>
...
@property (nonatomic, strong) GLPosterSelectView          *posterView;
...
@property (nonatomic, strong) GLMeituFreeContentView    *freeView;
