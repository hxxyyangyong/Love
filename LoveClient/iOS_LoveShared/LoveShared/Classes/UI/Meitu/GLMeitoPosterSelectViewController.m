//
//  GLMeitoPosterSelectViewController.m
//  Tuotuo
//
...
@interface GLMeitoPosterSelectViewController ()
...
@implementation GLMeitoPosterSelectViewController
...
- (void)initWithData
{
    NSString *dataJsonPATH = [[NSBundle mainBundle].resourcePath stringByAppendingPathComponent:@"Poster.geojson"];
...
//        [_petTableView addInfoText:D_LocalizedCardString(@"Prompt_After_Null")];
//        return;
//    }
...
//    item.type = E_ResourceType_MeituBoardList;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (tableView == _petTableView) {
        ...
        GLMeitoPosterSelectCell *cell  = (GLMeitoPosterSelectCell *)[tableView dequeueReusableCellWithIdentifier:cellIdentify];
        if (cell == nil) {
            cell = [[GLMeitoPosterSelectCell alloc] initWithStyle:UITableViewCellStyleDefault
...
//        if (sender.isEnable) {
            ...
            {
                [_delegateSelectPet didSelectedWithPoster:sender.posterDict isEmpty:sender.isEmpty];
            }
            [self dismissViewControllerAnimated:YES
                                     completion:^{
