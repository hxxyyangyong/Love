...
- (UIImage *)lastScreenShoot
{
    return [_screenShotsList lastObject];
}
...
- (void)paningGestureReceive:(UIPanGestureRecognizer *)recoginzer
{
    ...
    if (recoginzer.state == UIGestureRecognizerStateBegan) {
        ...
        if (!self.backgroundView)
        {
            ...
            self.backgroundView = [[UIView alloc]initWithFrame:CGRectMake(0, IOS7?0:20, frame.size.width , frame.size.height)];
